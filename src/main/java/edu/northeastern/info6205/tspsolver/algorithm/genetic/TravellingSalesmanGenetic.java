...
public class TravellingSalesmanGenetic {
    ...
    public TravellingSalesmanGenetic(int numberOfCities, SelectionType selectionType, double[][] travelPrices, int startingCity, int targetFitness){
     ...
     */
    public static double[][] generateRandomMatrix(List<Point> points)
    {
