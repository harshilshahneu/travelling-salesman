package edu.northeastern.info6205.tspsolver.constant;

public class Constant {
	public static final String APP_NAME = "Travelling Salesman Solver";
	...
	public static final String KEY_IDENTIFIER_ANT_COLONY_THREE_OPT = "ant-colony-three-opt";
