...
public class HaversineDistanceTest {
    ...
    public void haversineBetweenSamePoints() {
        ...
        double distance = HaversineDistance.haversine(point1, point2);
    ...
    public void test5() {
        ...
        double distanceInMeters = HaversineDistance.haversine(northPole, southPole);
    ...
    public void haversineBetweenSamePoints2() {
        ...
        double distance = (float)HaversineDistance.haversine(point1, point2);
